...
st.link_button("Instructions", "https://gbvgenerator.streamlit.app/~/+/Instructions_For_GBV_With_Measurements#ec5a4dc8")
...
if run_button:
    ...
    # Create a new df of the first set of connections
